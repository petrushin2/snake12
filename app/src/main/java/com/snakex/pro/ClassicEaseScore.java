...
public class ClassicEaseScore extends AppCompatActivity {
...
//        RelativeLayout classicScoreLayout = (RelativeLayout) findViewById(R.id.classic_score_layout);
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                playAgainImageView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intentClassic = new Intent(ClassicEaseScore.this, EasySnake.class);
    ...
    private void initMainMenu(){
        ...
        animation = AnimationUtils.loadAnimation(ClassicEaseScore.this,R.anim.anim_for_bomb_button);
        animation.setDuration(GameSettings.ANIMATION_OPEN_BUTTON_DURATION);
        animation.setAnimationListener(new Animation.AnimationListener() {
            @Override
            public void onAnimationStart(Animation animation) {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                mainMenuImageView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        //reverse animation
                        Animation animationScore = AnimationUtils.loadAnimation(ClassicEaseScore.this,R.anim.reverse_for_classic_button);
                        animationScore.setDuration(GameSettings.ANIMATION_CLOSE_BUTTON_DURATION);

                        Animation animationHighScore = AnimationUtils.loadAnimation(ClassicEaseScore.this,R.anim.reverse_for_no_button);
                        animationHighScore.setDuration(GameSettings.ANIMATION_CLOSE_BUTTON_DURATION);

                        Animation animationPlayAgain = AnimationUtils.loadAnimation(ClassicEaseScore.this,R.anim.reverse_for_settings_button);
                        animationPlayAgain.setDuration(GameSettings.ANIMATION_CLOSE_BUTTON_DURATION);

                        Animation animationMainMenu = AnimationUtils.loadAnimation(ClassicEaseScore.this,R.anim.reverse_for_bomb_button);
                        animationMainMenu.setDuration(GameSettings.ANIMATION_CLOSE_BUTTON_DURATION);

                        //title animations
                        Animation animationTitleLeft = AnimationUtils.loadAnimation(ClassicEaseScore.this,R.anim.anim_for_title_left);
                        animationTitleLeft.setDuration(GameSettings.ANIMATION_SHOW_TITLE_DURATION);

                        Animation animationTitleRight = AnimationUtils.loadAnimation(ClassicEaseScore.this,R.anim.anim_for_title_right);
                        animationTitleRight.setDuration(GameSettings.ANIMATION_SHOW_TITLE_DURATION);

                        Animation animationTitleMiddle = AnimationUtils.loadAnimation(ClassicEaseScore.this,R.anim.anim_for_title_middle);
                        ...
                        myHandler.postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                Intent intentMain = new Intent(ClassicEaseScore.this, MainMenuActivity.class);
    ...
    private void initTitle(){
        ...
        Animation animationTitleLeft = AnimationUtils.loadAnimation(ClassicEaseScore.this,R.anim.back_anim_for_title_left);
        ...
        Animation animationTitleRight = AnimationUtils.loadAnimation(ClassicEaseScore.this,R.anim.back_anim_for_title_right);
        ...
        Animation animationTitleMiddle = AnimationUtils.loadAnimation(ClassicEaseScore.this,R.anim.back_anim_for_title_middle);
